import { getLessonById } from '@/features/curriculum/data/lessons'
import type { LessonMetadata } from '@/features/curriculum/types'

// We need to handle days 8-30 that don't have full metadata yet
...
export function useLesson(lessonId: string): LessonMetadata | undefined {
  return getLessonById(lessonId) ?? getPlaceholderLesson(lessonId)
}
