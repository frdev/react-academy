...
import { db, upsertLessonProgress, upsertUserStats, getUserStats } from '../db/progressDb'
import {
  type LessonProgress,
  type UserStats,
  type Achievement,
...
export const useProgressStore = create<ProgressState>((set, get) => {
  async function checkAchievements(
    ...
    // Week 1 complete (days 1-7 all completed)
    ...
    // Week 3 complete (days 15-21 all completed)
    ...
    // Week 4 complete (days 22-30 all completed)
    ...
    actions: {
      ...
      submitQuiz: async (lessonId: string, score: number) => {
        ...
        if (isNowComplete) {
          ...
          // Check achievements with updated progress and stats
